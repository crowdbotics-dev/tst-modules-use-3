"""
Django settings for tst_modules_use_3 project.
...
ROOT_URLCONF = 'tst_modules_use_3.urls'
...
WSGI_APPLICATION = 'tst_modules_use_3.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "tst_modules_use_3 API",
    "DESCRIPTION": "API documentation for tst_modules_use_3 App",
    "VERSION": "v1",
}
